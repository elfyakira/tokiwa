    ...
    <section id="seikan" className="py-16 lg:py-24 bg-white scroll-mt-24">
      <div className="max-w-container mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <FadeInUp delay={0.1}>
            <div className="space-y-6 text-text-primary leading-[1.8]">
              <p>自社で常備在庫を保管し、切断・穴加工をユニットワーカーで加工することで、材料手配から加工までを一貫して対応しています。製缶製作においては歪み・対角などを常に意識し、寸法の誤差を最小限におさえた精度の高い製品を造り上げます。</p>
              <p>重要な穴ピッチなどは、板金屋ならではの鉄板でゲージを製作し、正確な穴ピッチでの加工を実現しています。こうした現場の知恵と経験の積み重ねが、品質の安定と信頼につながっています。急な納期や仕様変更にも、在庫を活かした迅速な対応が可能です。お客さまからは「頼んだらすぐに正確なものが出てくる」と評価をいただいています。</p>
            </div>
          </FadeInUp>
          <FadeInUp delay={0.2}>
            <div className="space-y-4">
