        ...
        <FadeInUp>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-sm lg:text-base text-text-secondary leading-[2.2] text-left">
              私たちは、一つひとつの仕事に妥協なく向き合い、細かな仕事を確かな技術で積み重ねることが、お客さまの信頼につながると信じています。お客さまにとって「頼んで良かった」と思っていただける品質・納期を実現し、その満足が次の仕事へとつながっていく。この循環こそが、私たちのものづくりの原点です。現場では、経験豊富な職人と若手がそれぞれの個性を活かしながら支え合い、一貫した体制で設計から完成までを担います。社員一人ひとりが安心して働ける環境をつくることが、良いものづくりの土台になる。人を大切にし、技術を磨き続けることで、お客さまの製品価値を高める「欠かせない存在」であり続けます。
            </p>
          </div>
        </FadeInUp>
      </div>
  ...
  const visions = [
    {
      ...
      title: "信頼で選ばれ続ける存在へ",
      description:
        "納期・品質に妥協しないものづくりを貫き、お客さまにとって「なくてはならないパートナー」として選ばれ続ける会社を目指します。",
    },
    {
      number: "02",
