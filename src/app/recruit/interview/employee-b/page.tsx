        ...
        <div className="bg-white pt-8 pb-8 lg:pt-10 lg:pb-10">
          <div className="max-w-container mx-auto px-6 lg:px-12">
            <SectionTitleEntrance direction="left">
              ...
              <p className="mt-4 text-base text-text-secondary">製造部　Y.O</p>
        ...
        <div className="max-w-container mx-auto px-6 lg:px-12">
          ...
          <FadeInUp>
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-20 lg:mb-28">
              <div className="relative aspect-[4/3] rounded overflow-hidden lg:order-1">
                <Image
                  src="/images/interview-employee-b-2.jpg"
                  alt="インタビュー風景"
                  fill
                  className="object-cover"
                />
          ...
          <FadeInUp>
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-20 lg:mb-28">
              ...
              <div className="lg:mt-24 relative aspect-[4/3] rounded overflow-hidden">
                <Image
                  src="/images/interview-employee-b-3.jpg"
                  alt="インタビュー風景"
                  fill
                  className="object-cover"
                />
          ...
          <FadeInUp>
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-20 lg:mb-28">
              <div className="relative aspect-[4/3] rounded overflow-hidden lg:order-1">
                <Image
                  src="/images/interview-employee-b-4.jpg"
                  alt="インタビュー風景"
                  fill
                  className="object-cover"
                />
          ...
          <FadeInUp>
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-20 lg:mb-28">
              ...
              <div className="lg:mt-24 relative aspect-[4/3] rounded overflow-hidden">
                <Image
                  src="/images/interview-employee-b-5.jpg"
                  alt="インタビュー風景"
                  fill
                  className="object-cover"
                />
